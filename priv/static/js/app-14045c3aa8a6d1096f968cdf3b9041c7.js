...
require.register("badwords-list/lib/array.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "badwords-list");
  (function() {
...
require.register("badwords-list/lib/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "badwords-list");
  (function() {
    module.exports = {
...
require.register("badwords-list/lib/object.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "badwords-list");
  (function() {
...
require.register("badwords-list/lib/regexp.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "badwords-list");
  (function() {
...
require.register("profanity-censor/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "profanity-censor");
  (function() {
...
require.register("profanity-censor/lib/dictionary.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "profanity-censor");
  (function() {
    module.exports = [
  '2 girls 1 cup',
...
require.register("profanity-censor/lib/filter.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "profanity-censor");
  (function() {
...
require.register("profanity-censor/lib/use.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "profanity-censor");
  (function() {
    var dictionary = require('./dictionary');
...
var _profanityCensor = require("profanity-censor");

var profanity = _interopRequireWildcard(_profanityCensor);

var _badwordsList = require("badwords-list");

var badwords = _interopRequireWildcard(_badwordsList);
...
var App = function () {
    ...
    _createClass(App, null, [{
        ...
        value: function init() {
            ...
            var appendMessage = function appendMessage(x) {
            ...
            chan.on("msg:self", function (payload) {
                appendMessage("You say: " + payload.body);
            });

            chan.on("msg:new", function (payload) {
                appendMessage(payload.screen_name + " says: " + payload.body);
            });

            chan.on("msg:action", function (payload) {
                appendMessage("" + payload.action);
            });

            chan.on("msg:sys", function (payload) {
                appendMessage("" + payload.body);
            });

            chan.on("info:user", function (payload) {
            ...
            chan.on("info:room", function (payload) {
...
;require.alias("badwords-list/lib/index.js", "badwords-list");
